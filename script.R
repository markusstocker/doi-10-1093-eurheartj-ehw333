...
instance <- tp$students_ttest(
  ...
  has_specified_output=tp$pvalue(paste('the p-value of the statistical hypothesis test (p<',pvalue_ceil,')', sep=''), tp$scalar_value_specification(label = pvalue_str, pvalue)),
)
